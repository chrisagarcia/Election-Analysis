...
with open(file_to_save, "w") as txt_file:
    ...
    for county in counties:
        ...
        turnout_percent = float(turnout) * 100 / float(total_votes)

        # 6d: Print the county results to the terminal.
        display_county_stats = f'{county}:: {turnout_percent:.1f}% ({turnout:,})\n'
        print(display_county_stats)
        # 6e: Save the county votes to a text file.
        txt_file.write(display_county_stats)
